...
function res(answers){
	 ...
	 if (index <= 61){window.location.href="b612.html"}
	 else if(index <= 129){window.location.href="M78.html"}
	 else if(index <= 261){window.location.href="halei.html"}
	 else if(index <= 387){window.location.href="heidong.html"}
	 else if(index <= 457){window.location.href="kaipule.html"}
	 else if(index <= 525){window.location.href="kuaile.html"}
	 else if(index <= 569){window.location.href="muxing.html"}
	 else if(index <= 615){window.location.href="taiyang.html"}
	 else if(index <= 671){window.location.href="xinxiu.html"}
	 else {window.location.href="yueqiu.html"}
}
